...
print("I am going to add this on Cloud 9")
print("Taking a long time to modify work...")
print("I am going to make a quick change")
...
def roll_dice(num_rolls, dice=six_sided_dice, who='Boss Hogg'):
	...
	"*** YOUR CODE HERE ***"
	#returns the number of points scored by rolling a fixed positive number of dice
	#call dice()
	#call dice() num_rolls times
